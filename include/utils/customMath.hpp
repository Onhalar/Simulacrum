...
inline units::kilometers exponentialScale(const units::kilometers& minValue, const units::kilometers& MaxValue, const units::kilometers& currentValue, const float& maxScale) {
